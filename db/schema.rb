...
ActiveRecord::Schema[7.2].define(version: 2026_08_28_154500) do
  ...
  create_table "copilot_pending_admin_actions", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "user_id", null: false
    t.bigint "copilot_thread_id", null: false
    t.string "tool_name", null: false
    t.jsonb "action_params", default: {}, null: false
    t.integer "status", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_copilot_pending_admin_actions_on_account_id"
    t.index ["copilot_thread_id", "status"], name: "idx_on_copilot_thread_id_status_da15169c7c"
    t.index ["copilot_thread_id"], name: "index_copilot_pending_admin_actions_on_copilot_thread_id"
    t.index ["user_id"], name: "index_copilot_pending_admin_actions_on_user_id"
  end
